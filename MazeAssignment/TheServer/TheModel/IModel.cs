...
namespace TheServer.TheModel
{
    ...
    public interface IModel
    {
        ...
        Maze GenerateteSinglePlayerMaze(string name, int rows, int cols, Player player);
        string SolveMaze(string mazeName, string algorithm, Player player);
        ISearcher<Position> GetAlgorithmAccordingToIndicator(string algorithmIndicator);
        List<string> GetNamesOfJoinableMazes(Player player);
